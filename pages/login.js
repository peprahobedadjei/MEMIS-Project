        ...
        <div className="min-h-screen flex text-xs">
            ...
            <main className="flex w-full">
                ...
                {formType === 'reset' && (
                    <div className="flex flex-col w-full md:w-1/2">
                        <div className="p-5">
                            <a href="#" onClick={switchToLogin} className="text-sm font-semibold text-white">Forgot password</a>
                        </div>
                        <div className="flex flex-col justify-center items-center flex-1 p-6">
                            <div className="bg-white rounded-md  w-full max-w-md p-8">
                                {notification.message && (
                                ...
                                <h1 className="text-xl font-semibold text-center mb-1">Forgot password</h1>
                                <p className="text-center text-gray-600 text-sm mb-6">Please enter your email address</p>

                                <form onSubmit={handleResetSubmit}>
                                    <div className="mb-4">
                                        <label htmlFor="new-password" className="block text-sm font-medium text-gray-700 mb-1">Email Address</label>
                                        <div className="relative">
                                            <input
                                                type='text'
                                                id="email"
